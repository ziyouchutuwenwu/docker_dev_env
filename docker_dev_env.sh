...
# 共享目录为 \\ip\smb
docker run --rm -d --net dev-network --name smb -v ~/projects/docker/smb/:/mount -p 139:139 -p 445:445 dperson/samba -u "mmc;123456;1000;mmc;1000" -s "smb;/mount;yes;no;no;mmc" -p
